...
fn diffAtlas(
    ...
    var generated_read_buf: [4096]u8 = undefined;
    var generated_reader = generated_file.reader(io, &generated_read_buf);
    const generated_bytes = try generated_reader.interface.allocRemaining(alloc, .unlimited);
