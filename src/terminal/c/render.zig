...
pub fn get(
    ...
    if (comptime std.debug.runtime_safety) {
        _ = std.enums.fromInt(Data, @intFromEnum(data)) catch {
...
pub fn set(
    ...
    if (comptime std.debug.runtime_safety) {
        _ = std.enums.fromInt(SetOption, @intFromEnum(option)) catch {
...
pub fn row_cells_get(
    ...
    if (comptime std.debug.runtime_safety) {
        _ = std.enums.fromInt(RowCellsData, @intFromEnum(data)) catch {
...
pub fn row_get(
    ...
    if (comptime std.debug.runtime_safety) {
        _ = std.enums.fromInt(RowData, @intFromEnum(data)) catch {
...
pub fn row_set(
    ...
    if (comptime std.debug.runtime_safety) {
        _ = std.enums.fromInt(RowOption, @intFromEnum(option)) catch {
